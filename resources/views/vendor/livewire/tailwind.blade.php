<div>
  @if ($paginator->hasPages())
    <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between justify-content-center" style="text-align: center;">
  ...
  -->
      <div class="d-flex justify-content-between hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        <div>
