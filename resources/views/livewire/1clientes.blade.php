<div>
    ...
    <div class="row mb-1">
        ...
        <div class="col-sm-10">
            <input wire:change="searchShowModal" class="form-control me-2" type="search" placeholder="Search"
                aria-label="Search">
        </div>
    </div>
                                ...
                                @if ($clientes->count())
                                    @foreach ($clientes as $cliente)
                                        <tr>
                                            ...
                                            <td class="">
                                                <x-jet-button class="btn btn-sm btn-success mb-1"
                                                    wire:click="updateShowModal({{ $cliente->id }})">
                                                    {{ __('Update') }}
                                                </x-jet-button>
                                                <x-jet-button class="btn btn-sm btn-danger"
                                                    wire:click="({{ $cliente->id }})" type="button" value="borrar">
                                                    {{ __('Delete') }}
                                                </x-jet-button>
                                            </td>
                                        </tr>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible" maxWidth="lg">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="nro_documento" class="block mt-1 w-full" type="number"
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="fecha_nacimiento" type="date" class="block mt-1 w-full"
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="celular1" class="block mt-1 w-full" type="number"
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="celular2" class="block mt-1 w-full" type="number"
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="direccion" class="block mt-1 w-full" type="text"
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="estado_civil" class="block mt-1 w-full" type="text"
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="lugar_trabajo" class="block mt-1 w-full" type="text"
