    ...
    <x-jet-dialog-modal wire:model="modalCrearCredito" maxWidth="lg">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                ...
                <x-jet-input type="number" step="any" id="porcent_interes_anual" class="block mt-1 w-full" wire:model="porcent_interes_anual" />
            ...
            <div class="mt-4">
                ...
                <x-jet-input type="number" step="any" id="porcent_interes_mensual" class="block mt-1 w-full" wire:model="porcent_interes_mensual" />
                @error('porcent_interes_mensual') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                <x-jet-label for="usu_crea" value="{{ _('Asesor asignado') }}" />
                <x-jet-input type="number" step="any" id="usu_crea" class="block mt-1 w-full" wire:model="usu_crea" />
                @error('usu_crea') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                <x-jet-label for="valor_abonado" value="{{ _('Saldo abonado') }}" />
                <x-jet-input type="number" step="any" id="valor_abonado" class="block mt-1 w-full" wire:model="valor_abonado" />
                @error('valor_abonado') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                <x-jet-label for="valor_capital" value="{{ _('Abono Capital') }}" />
                <x-jet-input type="number" step="any" id="valor_capital" class="block mt-1 w-full" wire:model="valor_capital" />
                @error('valor_capital') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                <x-jet-label for="valor_cuota" value="{{ _('Valor de cuota') }}" />
                <x-jet-input type="number" step="any" id="valor_cuota" class="block mt-1 w-full" wire:model="valor_cuota" />
                @error('valor_cuota') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                <x-jet-label for="valor_interes" value="{{ _('Abono interés') }}" />
                <x-jet-input type="number" step="any" id="valor_interes" class="block mt-1 w-full" wire:model="valor_interes" />
                @error('valor_interes') <span class="error">{{ $message }}</span> @enderror
            </div>
            <div class="mt-4">
                <x-jet-label for="estado" value="{{ _('Estado crédito') }}" />
                <x-jet-input type="number" step="any" id="estado" class="block mt-1 w-full" wire:model="estado" />
