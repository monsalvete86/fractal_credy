                    ...
                    <div class="col-sm-12 col-lg-12 col-md-8  ">
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                ...
                                <input id="nombres" class="form-control" type="text" wire:model.lazy="nombres">
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                ...
                                <input id="email" class="form-control" type="text" wire:model.lazy="email">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-12">
                                <label for="independiente">Independiente</label>
                                <select name="independiente" id="independiente" class="custom-select"
                                    wire:model.debounce.800ms="independiente">
                                    <option value="" disabled>--Seleccionar--</option>
