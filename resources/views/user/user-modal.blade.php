                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" id="nombreCorto" wire:model="nombreCorto" class="form-control"
                                    required>
                                @error('nombreCorto')
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" id="nombreUsuario" wire:model="nombreUsuario" class="form-control"
                                    required>
                                @error('nombreUsuario')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <select class="form-control" wire:model="idSede" id="idSede" required>
                                    ...
                                    @foreach ($sedes as $dataSede)
                                        <option value={{ $dataSede->id }} @if ($dataSede->id == $idSede) selected @endif>
                                            {{ $dataSede->sede }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12 col-sm-6">
                                ...
                                <select class="form-control" wire:model="idRol" id="idRol" required>
                                    ...
                                    @foreach ($roles as $dataRol)
                                        <option value="{{ $dataRol->id }}" @if ($dataRol->id == $idRol) selected @endif>
                                            {{ $dataRol->rol }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="password" id="password" wire:model="password" class="form-control" value=""
