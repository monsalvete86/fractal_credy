<div>
    <div wire:ignore.self style="{{ $modalStyle }}" class="modal " id="proveedorModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <form wire:submit.prevent="@if ($modelId) update() @else create() @endif">
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="genero" class="form-control" type="text" wire:model.debounce.800ms="genero">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                            class="btn btn-success">{{ $modelId ? 'Actualizar' : 'Crear' }}</button>
                    </div>
                </form>
            </div>
        </div>
