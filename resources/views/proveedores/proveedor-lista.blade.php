        ...
        @if ($proveedores->count())
          @foreach ($proveedores as $proveedor)
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-sm btn-success mb-1" data-toggle="modal" data-target="#proveedorModal" wire:click="actualizarProveedor({{ $proveedor }})">
                  Actualizar
                </button>
                <button class="btn btn-sm btn-danger" wire:click="delete('{{ $proveedor->id }}')" type="button"  value="borrar">
                  Eliminar
                </button>
              </td>
            </tr>
